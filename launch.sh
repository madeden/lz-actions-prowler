...
#FIRST_ROLE="arn:aws:iam::155053156634:role/AWSLandingZoneSecurityReadOnlyRole"
#SECOND_ROLE="arn:aws:iam::239811223963:role/AWSLandingZoneReadOnlyListAccountsRole"

#export AWS_ACCESS_KEY_ID="AKIASIGPDNENAHHWGMOX"
#export AWS_SECRET_ACCESS_KEY="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"
...
#    docker run --rm --name "prowler-$x" --env AWS_ACCESS_KEY_ID --env AWS_SECRET_ACCESS_KEY --env AWS_SESSION_TOKEN toniblyx/prowler:latest > "/tmp/prowler-$x" 2>&1 &
